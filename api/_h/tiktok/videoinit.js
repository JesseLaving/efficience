/* TikTok Content Posting API — step 1 of a Direct Post: initialize the
   upload (small JSON body, fits comfortably in a serverless function) and
...
export default async function handler(req, res) {
  ...
  const { token, title, privacyLevel, fileSize, disableComment, disableDuet, disableStitch } = body || {};
